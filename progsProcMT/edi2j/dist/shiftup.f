...
C       character table (256) /
     ...
     &            ns, ' ', string(:ns)
      ...
      do 1 i = 1, ns
c	write(*,*)'i, string(i:i)=',i,' ',string(i:i)
c	write(*,*)'ichar(string(i:i))=',ichar(string(i:i))
c	write(*,*)'table(ichar(string(i:i)))=',
c    &             table(ichar(string(i:i)))
c	write(*,*)'char(table(ichar(string(i:i))))=',
c    &             char(table(ichar(string(i:i))))
        ic = ichar(string(i:i))
        tc = table(ic)
        string(i:i) = char(tc)

...
c             write(*,*) 'rotation pair #, cc',i,cc
c             write(*,*) 'orientations',orient1
         do k = 1,nvec
...
ccc            at least two E at station ista ... assume first two are Ex/Ey
      ...
      enddo
       write(*,*) 'npair = ',npair
       write(*,*) 'rotation pairs',(ipair(1,k),ipair(2,k),k=1,npair)

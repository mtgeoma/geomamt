...
table readtbl(string tblstr) {
    ...
    if(positioning(tblf,"SNUM")) {
        tblf.read(&tbl.snum,sizeof(tbl.snum));
        if(bswap)
    ...
    if(positioning(tblf,"SRPM")) {
        tblf.read(&tbl.srpm,sizeof(tbl.srpm));
        if(bswap)
    ...
    if(positioning(tblf,"AWIN")) {
        tblf.read(&tbl.awin,sizeof(tbl.awin));
        if(bswap)
    ...
    if(positioning(tblf, "EGN")) {
        tblf.read(&tbl.egn,sizeof(tbl.egn));
        if(bswap)
    ...
    if(positioning(tblf, "HGN")) {
        tblf.read(&tbl.hgn,sizeof(tbl.hgn));
        if(bswap)
    ...
    if(positioning(tblf, "EAZM")) {
        tblf.read(&tbl.eazm,sizeof(tbl.eazm));
        if(bswap)
    ...
    if(positioning(tblf, "EXLN")) {
        tblf.read(&tbl.exln,sizeof(tbl.exln));
        if(bswap)
    ...
    if(positioning(tblf, "EYLN")) {
        tblf.read(&tbl.eyln,sizeof(tbl.eyln));
        if(bswap)
    ...
    if(positioning(tblf, "HAZM")) {
        tblf.read(&tbl.hazm,sizeof(tbl.hazm));
        if(bswap)
    ...
    if(positioning(tblf, "BSEX")) {
        tblf.read(&tbl.bsex,sizeof(tbl.bsex));
        if(bswap)
    ...
    if(positioning(tblf, "BSEY")) {
        tblf.read(&tbl.bsey,sizeof(tbl.bsey));
        if(bswap)
    ...
    if(positioning(tblf, "BSEZ")) {
        tblf.read(&tbl.bsez,sizeof(tbl.bsez));
        if(bswap)
    ...
    if(positioning(tblf, "ELEV")) {
        tblf.read(&tbl.elev,sizeof(tbl.elev));
        if(bswap)
    ...
    if(positioning(tblf, "LATG")) {
        ...
        if(bswap)
            tbl.latg=(float8)bswap_64((int8)tbl.latg);
    }
    else {
    ...
    if(positioning(tblf, "LNGG")) {
        ...
        if(bswap)
            tbl.lngg=(float8)bswap_64((int8)tbl.lngg);
    }
    else {
    ...
    if(positioning(tblf, "HNOM")) {
        tblf.read(&tbl.hnom,sizeof(tbl.hnom));
        if(bswap)

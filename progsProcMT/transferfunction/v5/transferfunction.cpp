...
inline void TransferFunction::set_prop_error(prop_error p_err) {
	p_error=p_err;
}
...
double TransferFunction::alfa(int signal) {
  ...
  double f2=2.*commutRe(D1,S2);
	...
	double sqrt_tmp=0.25*pow((b1*a2+a1*b2+c1*e2)/(a1*a2-c1*c2+c1*f2),2);
	       sqrt_tmp-=(b1*b2-c1*c2)/(a1*a2-c1*c2+c1*f2);
	       sqrt_tmp=sqrt(sqrt_tmp);

	double alfae=0.5*(b1*a2+a1*b2+c1*e2)/(a1*a2-c1*c2+c1*f2);
	if(signal>0)

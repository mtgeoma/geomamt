...
C     SET UP BASE ADDRESSES FOR WORK ARRAYS
      ...
      IEL = LIMIT + IBL
      IRL = LIMIT + IEL
C     PERFORM INTEGRATION WITH KEY > 5, WHICH CORRESPONDS TO D01AKZ.
      KEY = 6
      CALL D01AKV(F,A,B,KEY,ABS(EPSABS),ABS(EPSREL),WORK(1),WORK(IBL),
...
C     ARE EASILY ACCESSIBLE TO THE USER (SEE D01AKV).
      LAST = IWORK(1)

      SUBROUTINE D03PHR(NEQN,NPDE,NPTS,X,U,WK,IWK,M,TS,IBAND,ITIME,
     *                  REMESH,MAXNPT,NV,NXI,XI,XFIX,NXFIX,IXFIX,NIXFIX,
     *                  UVINIT,PHFPDE,PDEPCF,SPDEF1,MONFFD,MONFKB)
...
C     the routines  D03PHJ , D03PZW and D03PCN .
C
...
C
   ...
   40    CONTINUE
      ...
      NNPDE = NPDE
C
C ... If ITIME>1, NPTS and NEQN updated in D03PCN ...
...
C
         ...
         J = 1
C
         CALL D03PHH(PHFPDE,PDEPCF,TS,M,U,NPDE,NNPTS,WK,IWK,U(NVST),NV,
...
C
  ...
  120    CONTINUE
      END IF
C
C ... Call D03PCW so as to define the coefficients of ...

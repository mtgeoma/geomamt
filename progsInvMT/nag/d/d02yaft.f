      SUBROUTINE D02YAF(X,H,N,Y,FCN,W,IW1,IW2)
...
C     .. Scalar Arguments ..
      ...
      INTEGER           IW1, IW2, N
C     .. Array Arguments ..
      DOUBLE PRECISION  W(IW1,IW2), Y(N)

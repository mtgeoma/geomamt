      SUBROUTINE D02EHZ(N,X,Y,HU,XLAST,H,RNQU,YSAV,ACOR,CHK,IMON,NSTPS,
     *                  GLAST,USRHMX,HMAX,G,IFLAG,D,IFIN,DIR,ROOT)
C     MARK 12 RELEASE. NAG COPYRIGHT 1986.
C     .. Scalar Arguments ..
      DOUBLE PRECISION  DIR, GLAST, H, HMAX, HU, RNQU, ROOT, X, XLAST
      INTEGER           IFIN, IFLAG, IMON, N, NSTPS
      LOGICAL           USRHMX
C     .. Array Arguments ..

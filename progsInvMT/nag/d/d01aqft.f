...
C     PERFORM INTEGRATION
      CALL D01AQV(F,A,B,C,ABS(EPSABS),ABS(EPSREL),WORK(1),WORK(IBL),
...
C     ARE EASILY ACCESSIBLE TO THE USER (SEE D01AQV).
      LAST = IWORK(1)
...
99997 FORMAT (' ** Round-off error prevents the requested tolerance fr',
     ...
     *       '  EPSREL = ',1P,D8.1)
99996 FORMAT (' ** On entry, C.eq.A or C.eq.B:',/'    A = ',1P,D13.5,
     *       '   B = ',1P,D13.5,'   C = ',1P,D13.5)
      END

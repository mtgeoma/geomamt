...
C     PERFORM INTEGRATION
      CALL D01ATV(F,A,B,ABS(EPSABS),ABS(EPSREL),WORK(1),WORK(IBL),
...
C     ARE EASILY ACCESSIBLE TO THE USER (SEE D01ATV).
      LAST = IWORK(1)

      SUBROUTINE D01AKV(F,A,B,KEY,EPSABS,EPSREL,ALIST,BLIST,ELIST,RLIST,
...
C     .. External Subroutines ..
      EXTERNAL          D01AJX, D01AKZ, X04AAF, X04BAF
...
C
      ...
      C = KEYF
      NEVAL = 0
C     IF (KEYF.EQ.1) CALL D01AKU(F,A,B,RESULT,ABSERR,DEFABS,RESABS)
C     IF (KEYF.EQ.2) CALL D01AJZ(F,A,B,RESULT,ABSERR,DEFABS,RESABS)
C     IF (KEYF.EQ.3) CALL D01AKW(F,A,B,RESULT,ABSERR,DEFABS,RESABS)
C     IF (KEYF.EQ.4) CALL D01AKX(F,A,B,RESULT,ABSERR,DEFABS,RESABS)
C     IF (KEYF.EQ.5) CALL D01AKY(F,A,B,RESULT,ABSERR,DEFABS,RESABS)
C     IF (KEYF.EQ.6) CALL D01AKZ(F,A,B,RESULT,ABSERR,DEFABS,RESABS)
...
C
         ...
         A2 = B1
         B2 = BLIST(MAXERR)
C        IF (KEYF.EQ.1) CALL D01AKU(F,A1,B1,AREA1,ERROR1,RESABS,DEFAB1)
C        IF (KEYF.EQ.2) CALL D01AJZ(F,A1,B1,AREA1,ERROR1,RESABS,DEFAB1)
C        IF (KEYF.EQ.3) CALL D01AKW(F,A1,B1,AREA1,ERROR1,RESABS,DEFAB1)
C        IF (KEYF.EQ.4) CALL D01AKX(F,A1,B1,AREA1,ERROR1,RESABS,DEFAB1)
C        IF (KEYF.EQ.5) CALL D01AKY(F,A1,B1,AREA1,ERROR1,RESABS,DEFAB1)
C        IF (KEYF.EQ.6) CALL D01AKZ(F,A1,B1,AREA1,ERROR1,RESABS,DEFAB1)
C        IF (KEYF.EQ.1) CALL D01AKU(F,A2,B2,AREA2,ERROR2,RESABS,DEFAB2)
C        IF (KEYF.EQ.2) CALL D01AJZ(F,A2,B2,AREA2,ERROR2,RESABS,DEFAB2)
C        IF (KEYF.EQ.3) CALL D01AKW(F,A2,B2,AREA2,ERROR2,RESABS,DEFAB2)
C        IF (KEYF.EQ.4) CALL D01AKX(F,A2,B2,AREA2,ERROR2,RESABS,DEFAB2)
C        IF (KEYF.EQ.5) CALL D01AKY(F,A2,B2,AREA2,ERROR2,RESABS,DEFAB2)
C        IF (KEYF.EQ.6) CALL D01AKZ(F,A2,B2,AREA2,ERROR2,RESABS,DEFAB2)

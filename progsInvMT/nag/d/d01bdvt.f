      SUBROUTINE D01BDV(F,A,B,EPSABS,EPSREL,RESULT,ABSERR,NEVAL,IER)
...
C           A GIVEN DEFINITE INTEGRAL  I = INTEGRAL OF  F  OVER (A,B),
...
C                            DIFFICULT TO BE CALCULATED BY D01BDV.
C
C     ..................................................................
C
C           THE FOLLOWING DATA STATEMENTS CONTAIN THE ABSCISSAE
C           AND WEIGHTS OF THE INTEGRATION RULES USED.
C
C           X1      ABSCISSAE COMMON TO THE 10-, 21-, 43- AND 87-POINT
C                   RULE
...
C           W43A    WEIGHTS OF THE 43-POINT FORMULA FOR ABSISSAE X1, X3
...
C     .. Local Scalars ..
     ...
     *                  FVAL1, FVAL2, HLGTH, OFLOW, RES10, RES21, RES43,
     *                  RES87, RESABS, RESASC, RESKH, UFLOW
      INTEGER           IPX, K, L
C     .. Local Arrays ..
...
C           SAVFUN - ARRAY OF FUNCTION VALUES WHICH HAVE ALREADY
C                    BEEN COMPUTED

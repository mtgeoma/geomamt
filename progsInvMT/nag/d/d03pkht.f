      SUBROUTINE D03PKH(PKFPDE,PDEPEF,T,M,U,NPDE,NPTS,RESWK,NRESWK,V,NV,
     *                  MAXNPT,IRES,XI,NXI,XFIX,IXFIX,NXFIX,NF,UVINIT,
     *                  SPDEF1,MONFFD,MONFKB)
C     MARK 16 RELEASE. NAG COPYRIGHT 1993.
C     MARK 17 REVISED. IER-1551 (JUN 1995).
C
C  ---------------------------------------------------------------------
C     Routine to provide initial mesh by three calls to D03PRH.
C     (Keller Box Scheme version of D03PHH)
C  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
C     .. Scalar Arguments ..
      DOUBLE PRECISION  T
...
C     .. Local Scalars ..
      DOUBLE PRECISION  XP
      INTEGER           I, IFAIL, IONE, ISTATE, ITWO, K, K1, K2, K3, K4,
     *                  MIDNPT, NIP, NIPP1, NOP
      CHARACTER*80      REC
C     .. Local Arrays ..

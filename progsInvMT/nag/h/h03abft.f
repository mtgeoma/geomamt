...
C     MARK 17 REVISED. IER-1668 (JUN 1995).
...
C     .. Local Scalars ..
      DOUBLE PRECISION  X
      INTEGER           I, IDKS22, IDKS28, II, INF, J, J11, J21, J22, 
     *                  J23, J24, J25, J26, J27, J28, JC, JV, KI, KJ, 
     *                  KK, KKK, L, LC, LCK, LD, LDEL, LF, LR, LRH, LRK, 
     *                  LRMI, LSTA, LT, LTK, LTMI, LV, LVK, LVMI, LX, 
     *                  M1, MIN, MU
C     .. Local Arrays ..
...
C     .. Executable Statements ..
  ...
  260 CONTINUE
      ...
      KI = MA
      KJ = MB
*     Correction inserted by DKS - 3 May 1994      
      MIN = KOST(1,1)
      LRMI = 1
      LTMI = 1
*     End correction      
...
*     Correction inserted by DKS - 3 May 1994
      IDKS28 = SIGN(1,J28)
      IDKS22 = SIGN(1,-J22)
      IF (IDKS28.EQ.IDKS22) GO TO 1410
      GO TO 1415
 1410 IF (IDKS28) 1420, 1240, 1240
 1415 IF (J28-J22) 1420, 1240, 1240
*     End correction      
 1420 J22 = J28
      J11 = MU
      MU = J23

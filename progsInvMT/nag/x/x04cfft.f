...
C
  ...
  220 CONTINUE
C
  240 IFAIL = P01ABF(IFAIL,IERR,SRNAME,NREC,REC)
C
      RETURN
C
...
99996 FORMAT (1X,'** On entry, LDA.lt.KL+KU+1: LDA =',I16,',',/4X,
     *       'KL =',I16,', KU =',I16)

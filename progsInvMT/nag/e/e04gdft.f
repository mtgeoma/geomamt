...
C     .. Parameters ..
      CHARACTER*6       SRNAME
      PARAMETER         (SRNAME='E04GDF')
C     .. Scalar Arguments ..
      DOUBLE PRECISION  ETA, FSUMSQ, STEPMX, XTOL
      INTEGER           IFAIL, IPRINT, LIW, LJ, LVT, LW, M, MAXFUN, N,
     *                  NFTOTL, NITER
C     .. Array Arguments ..
...
C     .. External Subroutines ..
      EXTERNAL          E04GDP, E04HEU, E04HEV, E04HEX
...
C
      SECOND = .FALSE.
      CALL E04HEX(M,N,E04HEV,LSFJC,E04HEU,E04GDP,LSMON,SECOND,IPRINT,
     *            MAXFUN,ETA,XTOL,STEPMX,X,FSUMSQ,FVEC,FJAC,LJ,S,VT,LVT,
     *            NITER,NFTOTL,NWHY,IW,LIW,W,LW)
      ...
      ELSE IF (NWHY.EQ.1) THEN
         ...
         ELSE IF (M.LT.N) THEN
            ...
            NREC = 1
         ELSE IF (MAXFUN.LT.1) THEN
            WRITE (P01REC,FMT=99997) MAXFUN
            NREC = 1
...
99988 FORMAT (' ** There have been MAXFUN evaluations of the residuals',
     *       ': MAXFUN =',I15)
      END

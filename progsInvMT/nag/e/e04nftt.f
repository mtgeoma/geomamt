      SUBROUTINE E04NFT(CSET,N,NCLIN,LITOTL,LWTOTL)
C     MARK 16 RELEASE. NAG COPYRIGHT 1992.
C     MARK 17 REVISED. IER-1593 (JUN 1995).
C
C     ******************************************************************
C     E04NFT   allocates the addresses of the work arrays for E04NFZ.
C
C     Note that the arrays ( GQ, CQ ) lie in contiguous areas of
C     workspace.
C
C     Original version written  2-January-1987.
C     This version of E04NFT dated  18-Nov-1990.
C     ******************************************************************
C
C     .. Parameters ..
      INTEGER           LENLC
...
C     .. Local Scalars ..
     ...
     *                  LFEATU, LGQ, LHX, LKACTV, LKX, LQ, LR, LRLAM,
     *                  LT, LWRK, LWTINF, MINIW, MINW
C     .. Common blocks ..
      COMMON            /AE04MF/LOCLC

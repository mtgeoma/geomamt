      SUBROUTINE E04NFN(NOUT,BUFFER,KEY)
C     MARK 16 RELEASE. NAG COPYRIGHT 1992.
C     MARK 17 REVISED. IER-1588 (JUN 1995).
C
C     ******************************************************************
C     E04NFN   decodes the option contained in  BUFFER  in order to set
...
C
C
C     E04NFN  calls E04UDX and the subprograms
...
C
C     This version of E04NFN dated 10-Apr-94.
C     ******************************************************************
C
C     .. Parameters ..
      INTEGER           MXPARM
      ...
      PARAMETER         (MAXKEY=25,MAXTIE=7,MAXTOK=10,MAXTYP=10)
      INTEGER           IDUMMY
...
C     .. Data statements ..
     ...
     *                  KEYS(10)/'INFINITE        '/,
     *                  KEYS(11)/'ITERATIONS      '/,
     *                  KEYS(12)/'ITERS:ITERATIONS'/,
     *                  KEYS(13)/'ITNS :ITERATIONS'/,
     *                  KEYS(14)/'LIST            '/,
     *                  KEYS(15)/'MAXIMUM         '/,
     *                  KEYS(16)/'MAX     :MAXIMUM'/,
     *                  KEYS(17)/'MINIMIZ         '/,
...
C           IF (LOC3.EQ.0) THEN
C              WRITE (REC,FMT=99997) KEY3
C              CALL X04BAF(NOUT,REC)
C           END IF

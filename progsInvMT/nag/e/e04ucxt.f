...
C     MARK 17 REVISED. IER-1611 (JUN 1995).
C
C     ******************************************************************
...
C     .. Scalars in Common ..
     ...
     *                  NCDIFF, NFDIFF, NLNF, NLNJ, NLNX, NLOAD, NN,
     *                  NNCLIN, NNCNLN, NOUT, NPROB, NSAVE
      LOGICAL           NEWOPT
C     .. Arrays in Common ..
...
C
         IF (LCRASH.LE.1) THEN
            ...
            WRITE (REC,FMT=99998) NCLIN, N, NCNLN
            CALL X04BAY(IPRINT,3,REC)

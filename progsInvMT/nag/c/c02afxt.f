...
C     ARE COMPLEX COEFFICIENTS, AND ZSM AND ZLG THE SMALLEST AND LARGEST
C     ROOT IN MAGNITUDE, RESPECTIVELY.
C
...
C     COMMON BLOCK AC02AF), C02AFX CAN USE THESE INDICATORS TO INDICATE

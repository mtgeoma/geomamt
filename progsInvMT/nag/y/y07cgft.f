      SUBROUTINE Y07CGF(JOB,N,A,TITLE,NFIGB,NFIGA,NCOLS,NOUT)
C     MARK 13 RELEASE. NAG COPYRIGHT 1988.
C
C  Purpose
C  =======
C
C  Y07CGF  prints out the  triangular part  of  hermitian or  triangular
...
C  positions per line and the heading 'Lower triangle of A', then Y07CGF
C  may be called as
C
C     CALL Y07CGF( 'Row by row', 6, A, 'Lower triangle of A',
C    $             2, 5, 60, 6 )
C
C  To get  the default values for  NFIGB, NFIGA, NCOLS and NOUT,  Y07CGF
C  may be called as
C
C     CALL Y07CGF( 'Row by row', 6, A, 'Lower triangle of A',
C    $             -1, -1, -1, -1 )

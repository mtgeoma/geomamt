...
C     THE MATRIX OF THE RIGHT-HAND SIDES IS STORED IN THE
C     ARRAY B(IB,IR) AND THE CORRESPONDING IR SOLUTIONS ARE
C     OBTAINED, BY A BACKWARD AND FORWARD SUBSTITUTION, AS
C     THE COLUMN VECTORS OF THE ARRAY X(IX,IR). WHEN THE

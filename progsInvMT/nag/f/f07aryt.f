      SUBROUTINE F07ARY(N,A,LDA,K1,K2,IPIV,INCX)
C     MARK 15 RELEASE. NAG COPYRIGHT 1991.
C     ENTRY             ZLASWP(N,A,LDA,K1,K2,IPIV,INCX)
C
C  Purpose
C  =======
C
C  ZLASWP performs a series of row interchanges on the matrix A.

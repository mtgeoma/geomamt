      SUBROUTINE F07TWZ(UPLO,DIAG,N,A,LDA,INFO)
C     MARK 15 RELEASE. NAG COPYRIGHT 1991.
C     ENTRY             ZTRTI2(UPLO,DIAG,N,A,LDA,INFO)
C
C  Purpose
C  =======
C
C  ZTRTI2 computes the inverse of a complex upper or lower triangular
C  matrix A.
C
C  Arguments
C  =========
...
C
     ...
     *         THEN
      ...
      END IF
      IF (INFO.NE.0) THEN
         CALL F06AAZ('F07TWZ/ZTRTI2',-INFO)
         RETURN
      END IF
C

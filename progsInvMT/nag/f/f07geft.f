...
C     .. Entry Points ..
      ENTRY             DPPTRS(UPLO,N,NRHS,AP,B,LDB,INFO)
C
C  Purpose
C  =======
C
C  DPPTRS solves a system of linear equations A*X = B with a symmetric
...
C
      ...
      END IF
      IF (INFO.NE.0) THEN
         CALL F06AAZ('F07GEF/DPPTRS',-INFO)
         RETURN
      END IF
C

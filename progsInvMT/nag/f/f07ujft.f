...
C     .. Entry Points ..
      ENTRY             DTPTRI(UPLO,DIAG,N,AP,INFO)
C
C  Purpose
C  =======
C
C  DTPTRI computes the inverse of a real upper or lower triangular
...
C
     ...
     *         THEN
      ...
      END IF
      IF (INFO.NE.0) THEN
         CALL F06AAZ('F07UJF/DTPTRI',-INFO)
         RETURN
      END IF
C

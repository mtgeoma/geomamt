...
C
         IF ((UPLO.EQ.'U' .OR. UPLO.EQ.'u')) THEN
            IF ((DIAG.EQ.'U' .OR. DIAG.EQ.'u')) THEN
               ...
               IF (K.GT.0) THEN
                  DO 560 J = 2, N
                     CALL F06KJF(MIN(J-1,K),AB(MAX(K+2-J,1),J),1,SCALE,
     *                           SUM)
  560             CONTINUE
               END IF
            ELSE
               ...
               SUM = ONE
               DO 580 J = 1, N
                  CALL F06KJF(MIN(J,K+1),AB(MAX(K+2-J,1),J),1,SCALE,SUM)
  580          CONTINUE
            END IF
         ELSE
            IF ((DIAG.EQ.'U' .OR. DIAG.EQ.'u')) THEN
  ...
  600             CONTINUE
            ...
            ELSE
               ...
               SUM = ONE
               DO 620 J = 1, N
                  CALL F06KJF(MIN(N-J+1,K+1),AB(1,J),1,SCALE,SUM)
  620          CONTINUE
            END IF
         END IF

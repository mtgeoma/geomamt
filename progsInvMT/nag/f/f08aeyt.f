      SUBROUTINE F08AEY(SIDE,TRANS,DIRECT,STOREV,M,N,K,V,LDV,T,LDT,C,
     *                  LDC,WORK,LDWORK)
C     MARK 16 RELEASE. NAG COPYRIGHT 1992.
C     ENTRY             DLARFB(SIDE,TRANS,DIRECT,STOREV,M,N,K,V,LDV,T,
...
C                 W := W + C1'*V1'
C
                  CALL DGEMM('Transpose','Transpose',N,K,M-K,ONE,C,LDC,
...
C                 C1 := C1 - V1' * W'
C
                  CALL DGEMM('Transpose','Transpose',M-K,N,K,-ONE,V,LDV,

...
C
    2 WRITE(*,'(A\)')' GIVE DATA FILE [.DAT] ===> '
      READ(*,'(A)')FDAT
      OPEN(5,FILE=FDAT,STATUS='OLD',ERR=2)
C
    3 WRITE(*,'(A\)')' GIVE OUTPUT FILE [.RES] => '
      READ(*,'(A)')FRES
      OPEN(6,FILE=FRES,STATUS='NEW',ERR=3)
C
      WRITE(6,2001)
c	open(11,file='prdel1.dat')
C
      READ(5,1000)NPER
      READ(5,1001)(PER(I),I=1,NPER)
C
      CALL RE2ANZ
      CALL BOUMED
...
C
      WRITE(6,2000)
      WRITE(6,2001)N1
      WRITE(6,2002)(SY(J),J=1,N1)
      WRITE(6,2003)MD1
      WRITE(6,2002)(SZ(K),K=1,MD1)
      WRITE(6,2004)MH1
      WRITE(6,2002)(SZ(K),K=MD,M1)
      WRITE(6,2005)
      DO 10 K=1,M1
      do 51 j=1,n1
...
C
      WRITE(6,2001)J,SYY(J),SEX(IHPOL,J),SEY(IHPOL,J,1),
     /             SHX(IHPOL,J),SHY(IHPOL,J),SHZ(IHPOL,J)
      EXN=SEX(IHPOL,J)/ENOR
      EYN=SEY(IHPOL,J,1)/ENOR
      WRITE(6,2002)EXN,EYN,SEZ(IHPOL,J,1)
C
      WRITE(6,2003)J,SYY(J),SEX(IHPOL,J),SEY(IHPOL,J,2),
     /             SHX(IHPOL,J),SHY(IHPOL,J),SHZ(IHPOL,J)
      EYN=SEY(IHPOL,J,2)/ENOR
      WRITE(6,2002)EXN,EYN,SEZ(IHPOL,J,2)
C
      GOTO 9
C
    8 WRITE(6,2004)J,SYY(J),SEX(IHPOL,J),SEY(IHPOL,J,1),
     /             SHX(IHPOL,J),SHY(IHPOL,J),SHZ(IHPOL,J)
      EXN=SEX(IHPOL,J)/ENOR
      EYN=SEY(IHPOL,J,1)/ENOR
      WRITE(6,2002)EXN,EYN,SEZ(IHPOL,J,1)
...
C
      WRITE(6,2001)J,SYY(J),PERIOD,PERL,PERL2
      WRITE(6,2000)ZXX,ZXY,ZYXL,ZYYL,RAXY,RAXYL,PAXY,RAYXL,RAYXLL,
...
c      write(7,7002)syy(j),raxx,paxx,rayyl,payyl
      WRITE(6,2002)J,SYY(J),PERIOD,PERL,PERL2
      WRITE(6,2000)ZXX,ZXY,ZYXR,ZYYR,RAXY,RAXYL,PAXY,RAYXR,RAYXRL,
...
c      write(7,7002)syy(j),raxx,paxx,rayyr,payyr
      GOTO 1
C
    2 WRITE(6,2003)J,SYY(J),PERIOD,PERL,PERL2
      WRITE(6,2000)ZXX,ZXY,ZYXL,ZYYL,RAXY,RAXYL,PAXY,RAYXL,RAYXLL,
     /             PAYXL,PSWIFL,PANIZL,PSKEWL,WX,WY,TRA,TRP,TIA,TIP

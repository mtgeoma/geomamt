...
C     SECOND MODE
      ...
      PARAMETER (NRESMX =  MAX(NRES1MX,NRES2MX))
      PARAMETER (NPERMX =  MAX(NPER1MX,NPER2MX))
      PARAMETER (NSTAMX =  MAX(NSTA1MX,NSTA2MX))
      INTEGER NN0MX
      PARAMETER (NN0MX  = NN1MX + NN2MX)

...
100   CONTINUE
     ...
     >     DatInx,SSIndx,SSPara,StsInx)
      ...
      CALL LocateModelPosition(NMode,NSta,StartPos,StaLoc,
     >     Nzb,Ny0,Dy0, Ny,Dy,Cy,YDis,IniRho,PriRho,StaPos,StaNod,
     >     ModGrd,DFStatus)
     ...
     >        CPriorModel,DFStatus)
      ...
      CALL SetSmooth(NMode,NSta,Nzb,Ny,ZDis,YDis,StaPos,

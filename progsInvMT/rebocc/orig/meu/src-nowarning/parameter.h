...
C     FIRST MODE
      ...
      PARAMETER (NRES1MX =  2)
      PARAMETER (NPER1MX = 50,NSTA1MX = 36)
      PARAMETER (NN1MX   = NPER1MX*NSTA1MX*NRES1MX)

C     SECOND MODE
      INTEGER NPER2MX,NSTA2MX,NRES2MX,NN2MX
      PARAMETER (NRES2MX =  2)
      PARAMETER (NPER2MX = 50,NSTA2MX = 36)
      PARAMETER (NN2MX   = NPER2MX*NSTA2MX*NRES2MX)

C     THRID MODE
      INTEGER NPER3MX,NSTA3MX,NRES3MX,NN3MX
      PARAMETER (NRES3MX =  2)
      PARAMETER (NPER3MX = 50,NSTA3MX = 36)
      PARAMETER (NN3MX   = NPER3MX*NSTA3MX*NRES3MX)

      INTEGER NPERMX,NSTAMX,NRESMX,NPER0MX,NSTA0MX,NRES0MX
c     PARAMETER (NRES0MX =  MAX(NRES1MX,NRES2MX))
c     PARAMETER (NPER0MX =  MAX(NPER1MX,NPER2MX))
c     PARAMETER (NSTA0MX =  MAX(NSTA1MX,NSTA2MX))
c     PARAMETER (NRESMX  =  MAX(NRES3MX,NRES0MX))
c     PARAMETER (NPERMX  =  MAX(NPER3MX,NPER0MX))
c     PARAMETER (NSTAMX  =  MAX(NSTA3MX,NSTA0MX))

      PARAMETER (NRES0MX =  NRES1MX)
      PARAMETER (NPER0MX =  NPER1MX)
      PARAMETER (NSTA0MX =  NSTA1MX)
      PARAMETER (NRESMX  =  NRES3MX)
      PARAMETER (NPERMX  =  NPER3MX)
      PARAMETER (NSTAMX  =  NSTA3MX)
      INTEGER NN0MX
